...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <img src="images/logo3.png" class="navbar-header"  height="50" >
    </ul>
...
<iframe width="950"  height="500" style="border:0; position: relative; left:280px; margin: 30px;" src="https://www.youtube.com/embed/oLWepVmBioo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

  <footer class="text-center text-white " style="background-color: #f3f2b1;">
